...
builder.Services.AddDbContext<DBFinalContext>(option => option.UseSqlServer(
...
////app.UseAuthentication(); //ï³äêëþ÷åííÿ àâòåíòèô³êàö³¿
...
//app.MapControllerRoute(
//    name: "default",
//    pattern: "{controller=VirusGroups}/{action=Index}/{id?}");
